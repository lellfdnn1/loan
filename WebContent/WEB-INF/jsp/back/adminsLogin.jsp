...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>小额贷款---后台登录</title>
		<link href="${rootPath }/dwz_jui/themes/css/login.css" rel="stylesheet" type="text/css" />
		<link href="${rootPath }/common/source/myCss.css" rel="stylesheet" type="text/css" />
		<script type="text/javascript" src="${rootPath }/common/source/jquery-3.0.0.min.js"></script>
		<script type="text/javascript" src="${rootPath }/common/include/util.js"></script>
	</head>
<body>
	<div id="login">
		<div id="login_header">
				...
				<form action="${rootPath }/adminsLoginSubmit.htm" method="post">
					...
					<p>
						...
						<input class="code" type="text" size="5"  name="code"/> 
							<span><a href="#" onclick="return reflushImg('codeImg')">
								<img src="${rootPath }/code.htm" id="codeImg" alt="验证码" width="75"
							 height="24" />
							</a></span>
					</p>
					<div class="login_bar">
